 ...
 */
public class mahasiswaTambahData extends javax.swing.JFrame {
    Koneksi log = new Koneksi();
    /**
     * Creates new form mahasiswaTambahData
     */
    public mahasiswaTambahData() {
        initComponents();
        nampil();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(tablePanel1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 220, Short.MAX_VALUE)
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        try {
            ...
            if (rsLogin.getRow()==0){
                log.Eksekusi("INSERT INTO `mahasiswa` (`NIM`, `Nama`, `Prodi`) VALUES ('"+idTextField.getText()+"', '"+nameTextField.getText()+"', '" +programTextField.getText()+ "');","Berhasil Menyimpan");
                log.tampil(studentTable, "SELECT * FROM mahasiswa");
            } else {
                JOptionPane.showMessageDialog(null, "Maaf, Data sudah dimasukkan!");
                idTextField.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mahasiswaTambahData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
